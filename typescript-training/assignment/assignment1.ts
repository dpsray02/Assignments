...
console.log(`order has placed :${true}`);

//3.Person's phone number: "123-456-7890"
let phNumber : string ="123-456-7890";
console.log(`Person's ph number is:  "${phNumber}"`);
...
console.log(`person's favotite coloue is : "${colour}"`)

//10.Current year: 2023
let currenrYear : number =2023
console.log (`cueent year is : ${currenrYear}`)
...
console.log(`Rating of movie is:${movieRating} `)

//13.Person's blood type: 'A'
let bloodType : string = 'A'
console.log(`Person's blood type is '${bloodType}'`);

//14.Title of a book: "To Kill a Mockingbird"
let bookTitle : string = "To Kill a Mockingbird";
console.log(`Title of book is :"${bookTitle}"`)
...
console.log(`Time of an eveent is : ${eventTime}`)
